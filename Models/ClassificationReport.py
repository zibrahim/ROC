...
class ClassificationReport:
    ...
    def plot_pr_auc( self , output_path) :
        plt.figure(figsize=(4,4))

        for rs in self.model_results:
        ...
        plt.savefig(output_path + "pr_auc.pdf", bbox_inches='tight')

    def plot_auc( self, output_path ):
        plt.figure(figsize=(4,4))
        model_subsets = [x for x in self.model_results if ("3D" not in x.label)]
        for rs in model_subsets :
        ...
        plt.savefig(output_path + "auc.pdf", bbox_inches='tight')
