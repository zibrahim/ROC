...
def generate_aggregates(X, dynamic_columns, id_col, training_groups, outcome, outcomes):
    agg_df = pd.DataFrame()
    agg_df.insert(0, id_col, training_groups)
    agg_df.insert(0, outcome, outcomes)
...
def generate_aggregates_original(X, dynamic_columns, id_col, training_groups):
    agg_df = pd.DataFrame()
    agg_df.insert(0, id_col, training_groups)
