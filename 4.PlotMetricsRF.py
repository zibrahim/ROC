...
def main () :
    ...
    for p in prevalence_rates:
        input_file = output_path+"RF"+str(p)+".json"
    ...
    plt.savefig(output_path+"/Figures/RFprecision.png")
    ...
    plt.boxplot(rec)
    plt.xticks(ticks = ticks,  labels=prev)
    plt.savefig(output_path+"/Figures/RFrecall.png")
    ...
    plt.boxplot(aucs)
    plt.xticks(ticks = ticks,  labels=prev)
    plt.savefig(output_path+"/Figures/RFauc.png")
    ...
    plt.boxplot(aucs)
    plt.xticks(ticks=ticks, labels=prev)
    plt.savefig(output_path + "/Figures/RFprauc.png")
