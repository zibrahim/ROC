...
def main () :
    ...
    prevalence_rates = [ 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5]
    ...
    plt.savefig(output_path+"/Figures/SVMprecision.png")
    ...
    plt.boxplot(rec)
    plt.xticks(ticks = ticks,  labels=prev)
    plt.savefig(output_path+"/Figures/SVMrecall.png")
    ...
    plt.boxplot(aucs)
    plt.xticks(ticks = ticks,  labels=prev)
    plt.savefig(output_path+"/Figures/SVMauc.png")
    ...
    plt.boxplot(aucs)
    plt.xticks(ticks=ticks, labels=prev)
    plt.savefig(output_path + "/Figures/SVMprauc.png")
